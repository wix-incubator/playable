...
describe('container created by createContainer', () => {
  ...
  it('should have method for registering and resolving modules', () => {
    ...
    expect(valueRegistration.resolve.called).to.be.equal(true);
    ...
    expect(classARegistration.resolve.called).to.be.equal(true);
    ...
    expect(funcRegistration.resolve.called).to.be.equal(true);
