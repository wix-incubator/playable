...
export default function create(params: IPlayerConfig = {}, themeConfig?: ThemeConfig) {
  ...
  return new PlayerFacade(params, scope, defaultModules, themeConfig, additionalModules);
}
