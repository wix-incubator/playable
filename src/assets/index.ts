...
export function enterFullScreen(svgStyle: string): Element {
  return nodeFromString(`
    <svg xmlns="http://www.w3.org/2000/svg" width="14" height="14" viewBox="0 0 14 14">
      <path class="${svgStyle}" fill-rule="evenodd" d="M2 10H0v4h4v-2H2v-2zM0 1v3h2V2h2V0H0v1zm14-1h-4v2h2v2h2V0zm-2 12h-2v2h4v-4h-2v2z"/>
    </svg>
  `);
}
...
export function exitFullScreen(svgStyle: string): Element {
  return nodeFromString(`
    <svg xmlns="http://www.w3.org/2000/svg" width="21" height="21" viewBox="0 0 21 21">
      <path class="${svgStyle}" fill-rule="evenodd" d="M4 21h2v-6H0v2h4v4zM6 0H4v4H0v2h6V0zm9 6h6V4h-4V0h-2v6zm2 11h4v-2h-6v6h2v-4z"/>
    </svg>
  `);
}

export function overlayPlay(svgStyle: string): Element {
  return nodeFromString(`
    <svg xmlns="http://www.w3.org/2000/svg" width="36" height="36" viewBox="0 0 36 36">
        <g fill="none" fill-rule="evenodd">
            <circle cx="18" cy="18" r="17" class="${svgStyle}" stroke-width="2"/>
            <path class="${svgStyle}" d="M23.935 17.708l-10.313 6.033V11.676z"/>
        </g>
    </svg>
  `);
}
...
export function volume0(svgStyle: string): Element {
  return nodeFromString(`
...
export function volume50(svgStyle: string): Element {
  return nodeFromString(`
    <svg xmlns="http://www.w3.org/2000/svg" width="17" height="14" viewBox="0 0 17 14">
        <g class="${svgStyle}">
            <path class="${svgStyle}" d="M0 3.919h2.993v5.97H0V3.92zm2.995-.015L7 .924v12L2.995 9.882v-5.98z"/>
            <path class="${svgStyle}" d="M9.853 10.837a5.45 5.45 0 0 0 0-7.707"/>
        </g>
    </svg>
  `);
}

export function volume100(svgStyle: string): Element {
  return nodeFromString(`
    <svg xmlns="http://www.w3.org/2000/svg" width="17" height="14" viewBox="0 0 17 14">
        <g class="${svgStyle}">
            <path class="${svgStyle}" d="M0 3.919h2.993v5.97H0V3.92zm2.995-.015L7 .924v12L2.995 9.882v-5.98z"/>
            <path class="${svgStyle}" d="M12.793 13.716a9.607 9.607 0 0 0 0-13.586M9.853 10.837a5.45 5.45 0 0 0 0-7.707"/>
        </g>
    </svg>
  `);
}
