...
export default {
  [TEXT_LABELS.WATCH_ON_SITE_LABEL]: 'Watch On Site',
  [TEXT_LABELS.WATCH_ON_SITE_TOOLTIP]: 'Watch On Site',
  ...
  [TEXT_LABELS.VOLUME_CONTROL_VALUE]: percent => `Volume is ${percent}%`,
